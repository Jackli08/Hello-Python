...
base_url = 'https://www.spiderbuf.cn/playground/e03/2fe6286a4e5f'
header = {
...
f = open('E03.txt','a',encoding='utf-8')
for i in range(2,7):
    url = 'https://www.spiderbuf.cn' + roots.xpath("/html/body/main/div[2]/div/nav/ul/li[{}]/a/@href".format(i))[0]
